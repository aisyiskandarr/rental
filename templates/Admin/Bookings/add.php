...
<div class="card rounded-0 mb-3 bg-body-tertiary border-0 shadow">
    ...
    <?= $this->Form->create($booking, ['type' => 'file']) ?>
            <fieldset>
                ...
                <div class="row">
                    <div class="col-md-6">
                    <?php echo $this->Form->control('users_id', ['options' => $users, 'empty' => 'Select Users', 'class' => 'form-select']); ?>
                    </div>
                    <div class="col-md-6">
                    <?php echo $this->Form->control('vehicles_id', ['options' => $vehicles, 'empty' => 'Select Vehicles', 'class' => 'form-select']); ?>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                    <label>Upload License</label><?php echo $this->Form->control('license', ['type' => 'file', 'class' => 'form-control', 'label'=>false]); ?>
                    </div>
                </div>
                
                <div class="row">
                    <div class="col-md-6">
                    <?php echo $this->Form->control('hours'); ?>
                    </div>
