		...
		?>
            ...
            <tbody>
				...
				<td><?php echo $counter++ ?></td>
                    ...
                    <td><?= h($booking->nric) ?></td>
                    <td class="text-center"><?php if ($booking->license == NULL) {
							echo '<i class="fa-solid fa-circle-xmark text-danger"></i>';
						}elseif  ($booking->license != NULL) {
						echo '<i class="fa-solid fa-circle-check text-success"></i>';
						}
						?></td>
                    <td><?= $this->Number->format($booking->hours) ?></td>
...
<div class="card bg-body-tertiary border-0 shadow mb-4">
	<div class="card-body">
		<div class="card-title mb-0">Search</div>
			<div class="tricolor_line mb-3"></div>
			<?php echo $this->Form->create(null, ['valueSources' => 'query', 'url' => ['controller' => 'Bookings','action' => 'index']]); ?>
				<fieldset>
					<div class="mb-1"><?php echo $this->Form->control('id',['required' => false]); ?></div>
					<div class="mb-1"><?php echo $this->Form->control('users_id', ['options' => $users, 'empty' => 'Select User', 'class' => 'form-select']); ?></div>
					<div class="mb-1"><?php echo $this->Form->control('vehicles_id', ['options' => $vehicles, 'empty' => 'Select Vehicle', 'class' => 'form-select']); ?></div>
					<div class="mb-1"><?php 
						echo $this->Form->label('Booking Status');
						echo '<br/>';
						$options = [
						'0' => 'Approve',
						'1' => 'Pending',
