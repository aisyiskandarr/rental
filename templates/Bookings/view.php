		...
		<div class="dropdown mx-3 mt-2">
			...
			<i class="fa-solid fa-bars text-primary"></i>
				...
				<div class="dropdown-menu dropdown-menu-end" aria-labelledby="orederStatistics">
							<li><?= $this->Html->link(('Edit Booking'), ['action' => 'edit', $booking->id], ['class' => 'dropdown-item', 'escapeTitle' => false]) ?></li>
				<li><?= $this->Form->postLink(('Delete Booking'), ['action' => 'delete', $booking->id], ['confirm' => __('Are you sure you want to delete # {0}?', $booking->id), 'class' => 'dropdown-item', 'escapeTitle' => false]) ?></li>
				<li><hr class="dropdown-divider"></li>
				<li><?= $this->Html->link(('List Bookings'), ['action' => 'index'], ['class' => 'dropdown-item', 'escapeTitle' => false]) ?></li>
				<li><?= $this->Html->link(('New Booking'), ['action' => 'add'], ['class' => 'dropdown-item', 'escapeTitle' => false]) ?></li>
							</div>
		</div>
    </div>
</div>
	  ...
	  <div class="card bg-body-tertiary border-0 shadow">
        <div class="card-body">
            ...
            <table class ="table table-sm table-hover">
                <tr>
                <td width="35%">Application Date</td>

                    <td><?php echo date('M d, Y (h:i A)', strtotime($booking->created)); ?></td>
                </tr>
                <tr>

                    <td width="35%">Approval Date</td>

                    <td><?php echo date('M d, Y (h:i A)', strtotime($booking->modified)); ?></td>
                </tr>

                <tr>
                    <td>Booking Status</td>
                    <td width="15%"class="text-end"><?php if ($booking -> status == 1) {
                                echo '<span class= "badge bg-warning">Pending</span>';
