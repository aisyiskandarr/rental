            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="star-rating">
                        <input type="radio" id="star5" name="rate" value="5"><label for="star5" class="star">&#9733;</label>
                        <input type="radio" id="star4" name="rate" value="4"><label for="star4" class="star">&#9733;</label>
                        <input type="radio" id="star3" name="rate" value="3"><label for="star3" class="star">&#9733;</label>
                        <input type="radio" id="star2" name="rate" value="2"><label for="star2" class="star">&#9733;</label>
                        <input type="radio" id="star1" name="rate" value="1"><label for="star1" class="star">&#9733;</label>
                    </div>
                </div>
